  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'giphy_animation', link: '/editor/scraper/giphy_animation/' },
        ...
        { text: 'slido_event', link: '/editor/scraper/slido_event/' },
        { text: 'slido_poll', link: '/editor/scraper/slido_poll/' },
        { text: 'sofascore_cuptree', link: '/editor/scraper/sofascore_cuptree/' },
