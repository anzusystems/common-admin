...
export default defineConfig({
  ...
  head: [
    ['link', { rel: "icon", href: "/common-admin/favicon.ico?v=1"}],
    ['link', { rel: "apple-touch-icon", sizes: "180x180", href: "/common-admin/apple-touch-icon.png?v=1"}],
    ['link', { rel: "icon", type: "image/png", sizes: "32x32", href: "/common-admin/favicon-32x32.png?v=1"}],
    ['link', { rel: "icon", type: "image/png", sizes: "16x16", href: "/common-admin/favicon-16x16.png?v=1"}],
    ['link', { rel: "manifest", crossorigin: "use-credentials", href: "/common-admin/site.webmanifest?v=1"}],
