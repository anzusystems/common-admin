...
export const FilterInnerConfigKey: InjectionKey<FilterConfig> = Symbol.for(
  'anzu:FilterInnerConfigKey',
)

export const FilterSubmitResetCounterKey: InjectionKey<Ref<number>> = Symbol.for(
  'anzu:FilterSubmitResetCounterKey',
)
export const FilterSelectedKey: InjectionKey<
  Ref<Map<string, ValueObjectOption<string | number>[]>>
