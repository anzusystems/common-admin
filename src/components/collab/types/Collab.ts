...
export interface CollabRoomLocks extends Record<
  CollabFieldName,
  CollabFieldLock
> {}

export interface CollabRoomData extends Record<
  CollabFieldName,
  CollabFieldDataEnvelope
> {}

export interface CollabRoomPlainData extends Record<
  CollabFieldName,
  CollabFieldData
> {}
...
export type CollabChangeRoomLockCallbackTypes =
  CollabSuccessChangeRoomLockCallback | CollabFailedChangeRoomLockCallback;
...
export interface CollabClientToServerEvents {
  ...
  fetchRoomsInfo: (
    rooms: CollabRoom[],
    callback: (data: CollabRoomsInfo) => void,
  ) => void;
}
...
export interface CollabServerToClientEvents {
  ...
  startCollab: (
    room: CollabRoom,
    callback: (data: CollabRoomPlainData) => void,
  ) => void;
  requestToTakeModeration: (
    room: CollabRoom,
    user: CollabUserId,
