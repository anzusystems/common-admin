...
export const collabReconnectEventBusKey: EventBusKey<"reconnect"> = Symbol(
  "anzu:collabReconnect",
);
...
export function useCollabGatheringBufferDataEventBus() {
  return useEventBus<CollabGatheringBufferDataEvent>(
    collabGatheringBufferDataEventBusKey,
  );
}

export function useCollabApprovedJoinRequestEventBus() {
  return useEventBus<CollabApprovedJoinRequestEvent>(
    collabApprovedJoinRequestEventBusKey,
  );
}

export function useCollabRejectedJoinRequestEventBus() {
  return useEventBus<CollabRejectedJoinRequestEvent>(
    collabRejectedJoinRequestEventBusKey,
  );
}
...
export function useCollabRequestToTakeModerationEventBus() {
  return useEventBus<CollabRequestToTakeModerationEvent>(
    collabRequestToTakeModerationEventBusKey,
  );
}

export function useCollabKickedFromRoomEventBus() {
  return useEventBus<CollabKickedFromRoomEvent>(
    collabKickedFromRoomEventBusKey,
  );
}
...
export type CollabFieldLockTypeType =
  (typeof CollabFieldLockType)[keyof typeof CollabFieldLockType];
