...
const { cache, toFetch, fetch, add, addManual, addManualMinimal, has, get, isLoaded } =
  defineCached<DocId, DamKeyword, DamKeywordMinimal>(mapFullToMinimal, mapIdToMinimal, (ids) => {
